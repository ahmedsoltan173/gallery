...
<div class="container">
 ...
 @error('type')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="date" class="form-control"required name="date" id="exampleInputEmail1" aria-describedby="emailHelp">
                      @error('date')
                      <div class="text-danger">{{$message}}</div>
                      @enderror
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control"required name="description" id="exampleInputEmail1" aria-describedby="emailHelp">
                      @error('description')
                      <div class="text-danger">{{$message}}</div>
                      @enderror
                    </div>
